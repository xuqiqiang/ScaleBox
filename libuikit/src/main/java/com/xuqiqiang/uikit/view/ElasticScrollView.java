...
public class ElasticScrollView extends NestedScrollView {
    ...
    private boolean mElasticEnable = true;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (contentView == null || !mElasticEnable) return;
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (!mElasticEnable) return super.dispatchTouchEvent(ev);
    ...
    public void setElasticEnable(boolean enable) {
        mElasticEnable = enable;
    }
